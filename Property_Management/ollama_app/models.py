...
class PropertyContent(models.Model):
    ...
    hotel = models.ForeignKey(
        Hotel, on_delete=models.CASCADE, related_name='content')
...
class PropertySummary(models.Model):
    property = models.ForeignKey(
        PropertyContent, on_delete=models.CASCADE, related_name='summaries')
    propertyId = models.CharField(max_length=255, null=True, blank=True)
...
class PropertyReview(models.Model):
    property = models.ForeignKey(
        PropertyContent, on_delete=models.CASCADE, related_name='reviews')
    propertyId = models.CharField(max_length=255, null=True, blank=True)
